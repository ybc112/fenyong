...
export const STAKING_BANK_ABI = [
  ...
  "function stakeRecords(address user, uint256 stakeId) view returns (uint256 amount, uint256 startTime, bool active)",
  ...
  "function getUserStakes(address user) view returns (uint256[] stakeIds, uint256[] amounts, uint256[] startTimes, bool[] actives)",
  "function getStakeRecord(address user, uint256 stakeId) view returns (uint256 amount, uint256 startTime, bool active)",
